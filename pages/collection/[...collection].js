        ...
        <div className="container-fluid">
          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb justify-content-start">
              ...
              <li className="breadcrumb-item">
                <a href={"/" + data.category.parent.slug}>
                  {data.category.parent.title}
                </a>
              </li>
          ...
          <div className="products my-2">
            {data.category.products.map((curProduct) => {
              return (
                <CardProduct
                  parentCategory={data.category.parent.slug}
                  product={curProduct}
                />
              );
            })}
...
export async function getServerSideProps(link) {
  let slug = link.query.collection;
  const res = await fetch(`http://localhost/l8ecom/api/category/${slug}`);
